...
REPLANNER_RETURN = """
You have reached the recursion limit and must return a response to user now.
"""
REPLANNER_PROMPT = ChatPromptTemplate.from_template(
    ...
    Return an Act object with either a Response (if you're ready to provide a final answer) or a Plan (if you need more steps).
    For a Response, use the format: {{"action": {{"response": "Your final answer here"}}}}
    For a Plan, use the format: {{"action": {{"steps": ["Step 1", "Step 2", ...]}}}}
    """
)
